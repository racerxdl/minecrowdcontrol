...
public class Minecraft : SimpleTCPPack
{
    ...
    public override List<Effect> Effects => new List<Effect>
    {
        ...
        new Effect("Take 1 Heart", "take_heart"),
        new Effect("Give 1 Heart", "give_heart"),
        new Effect("Set Fire", "set_fire"),
        new Effect("Set Time to Night", "set_time_night"),
        new Effect("Set Time to Day", "set_time_day"),
        new Effect("Take 1 Food", "take_food"),
        new Effect("Give 1 Food", "give_food"),
        new Effect("Send Player to Spawn Point", "send_player_to_spawn_point"),
        new Effect("1HP", "take_all_hearts_but_half"),
        new Effect("Full HP", "fill_hearts"),
        new Effect("Invert Mouse (2 minutes)", "invert_mouse"),
        new Effect("Disable Jump (1 minute)", "disable_jump"),
        new Effect("Famine", "take_all_food"),
        new Effect("Feast", "fill_food"),
        new Effect("Rain (1 minute)", "make_it_rain"),
